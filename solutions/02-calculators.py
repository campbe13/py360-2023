...
'''
Write the code that asks the user to enter 2 numbers representing the width and length of a rectangle. 
...
'''
Write the code that asks the user to enter the price of a meal at a restaurant (remember those  ?? ). 
...
''''
Write the code that asks the user to enter 3 numbers representing the height, width and length of a cuboid. 
